...
window.DAppConnector = {
  type: 'cardano-dapp-connector-bridge',

  source: null,
  origin: null,

  walletNamespace: null, // eg. eternl as in window.cardano.eternl
...
window.initCardanoDAppConnectorBridge = function initCardanoDAppConnectorBridge(onBridgeCreated) {
